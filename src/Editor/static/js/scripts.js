...
!function (NioApp, $) {
  ...
  NioApp.FileManager = function () {
    $file_dload.on("click", function (e) {
      e.preventDefault();
      NioApp.Toast('<h5>Downloading Presentation as ZİP</h5>', 'success', {
...
!function (NioApp, $) {
  ...
  // Variable
  var $file_uload = $('.file-up-toast');
  NioApp.FileManager = function () {
    $file_uload.on("click", function (e) {
      e.preventDefault();
      NioApp.Toast('<h5>Uploading Presentation to the OCE</h5>', 'success', {
        position: 'bottom-center',
        icon: 'ni ni-upload-cloud',
        ui: 'is-dark'
      });
    });
  };
...
!function (NioApp, $) {
  ...
  // Variable
  var $file_pdf = $('.file-pdf-toast');
  NioApp.FileManager = function () {
    $file_pdf.on("click", function (e) {
      e.preventDefault();
      NioApp.Toast('<h5>Downloading Presentation as PDF</h5>', 'success', {
        position: 'bottom-center',
        icon: 'icon ni ni-file-pdf',
        ui: 'is-dark'
      });
    });
  };
